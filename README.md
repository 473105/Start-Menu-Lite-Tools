...
<br>This tool was intended for used on the vanilla Start Menu, although it can potentially work on heavily modified menus as well, since the program does not touch the UI structure. Try testing it in a VM first to avoid unpredictable behavior.
